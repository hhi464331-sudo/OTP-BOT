...
"""
                    ...
                    if order['status'] == 'active':
                        try:
                            await bot.send_message(order['user_id'], msg, parse_mode='HTML', reply_markup=kb_inline.otp_success_keyboard())
                        except: pass
                    
                    otp_groups = await db.get_otp_groups()
                    for group in otp_groups:
                        try:
                            await bot.send_message(group['chat_id'], msg, parse_mode='HTML', reply_markup=kb_inline.otp_success_keyboard())
                        except: pass
