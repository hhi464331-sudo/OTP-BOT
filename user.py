...
async def get_number_logic(message: types.Message, country_code, is_change=False):
    ...
    if not order: 
        return await message.edit_text("❌ Failed to get a number.", parse_mode='HTML')
    ...
    # স্ক্রিনশট ৩ এর মত হুবহু নীল দাগের ডিজাইন
    msg_text = f"""
...
<blockquote>📢 <i>এই নাম্বারে OTP পাঠানোর পর বটেই OTP পাবেন। যদি বটে OTP না আসে তাহলে OTP গ্রুপে OTP পাবেন।</i> 🌸
